...
## 5. Branch Integrity
- **Canonical Artifact:** `historical_replay_calibration_final.json`
- **Secrets:** No hardcoded provider URLs (masked in logs, inherited from env).
- **Cleanliness:** No stale "24h" artifacts or duplicate configs.
- **Merge Ready:** Yes.
