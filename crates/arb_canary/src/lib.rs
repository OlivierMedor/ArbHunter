...
//! - Cumulative realized loss cap (0.01 ETH, inert in sim mode)
...
/// - cumulative realized loss cap 0.01 ETH (future live use)
...
impl Default for CanaryPolicy {
    fn default() -> Self {
        Self {
            ...
            loss_cap_wei:              10_000_000_000_000_000, // 0.01 ETH
